...
function bindSettingsSelect() {
  for (const ele of document.getElementsByClassName('settingsSelectContainer')) {
...
function bindFileSelectors() {
  for (const ele of document.getElementsByClassName('settingsFileSelButton')) {
    ele.onclick = async (e) => {
...
function _saveModConfiguration(modConf) {
  for (const m of Object.entries(modConf)) {
